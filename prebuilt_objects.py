...
# Items
##########
# all_store_items = [OneHandedWeapon("Small Dagger", buy_price=5, min_damage=30,
#         max_damage=60, attack_speed=1),
#     OneHandedWeapon("Big Dagger", buy_price=10, min_damage=300, max_damage=600,
#         attack_speed=2),
#     Shield("Small Shield", buy_price=10),
#     TwoHandedWeapon("Small Polearm", buy_price=5, min_damage=30, max_damage=60,
#         attack_speed=1),
...
all_store_items = [
    ...
    Shield("Ice Buckler", buy_price=100, max_durability=3, item_rating=10,
           ...
           courage_skill=0,
           sanity_skill=0),
    TwoHandedWeapon("Simple Staff", buy_price=100, max_durability=3, item_rating=10,
                    health_maximum=0, health_current=0,
                    regeneration_speed=0,
                    recovery_efficiency=0,
                    climbing_ability=0,
