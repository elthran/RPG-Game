...
class Game(object):
    def __init__(self, hero=None):
        ...
        # The two below may need to be in the database? I'm not sure.
        # Will need to see how they work with multiple users.
...
def round_number_intelligently(number):
    """
    This will round a number based on its closeness to the next number.
    So (1.4) has a 40% chance to be rounded to a (2). It returns an integer.
    """
