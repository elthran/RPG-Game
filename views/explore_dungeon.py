...
def dungeon_entrance(name='', hero=None, location=None):
    ...
    page_links = [("Walk deeper into the", "{}".format(hero.current_location.children[0].url), "ruin", ".")]
    return flask.render_template('dungeon_exploring.html', hero=hero, game=hero.game, page_links=page_links)  # return a string
