...
PROFICIENCY_INFORMATION = [
    ("Health", "When your health reahes zero you fall unconscious.", "Vitality", ["linear", 5, 2, 0], False, False),
    ("Regeneration", "How many health points you recover each day.", "Vitality", ["linear", 1, 0.5, 1], False, False),
