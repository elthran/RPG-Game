...
ALL_NAMES = ['Accuracy', 'Adventuring', 'Bartering', 'Block', 'Block amount', 'Blunt', 'Caution level', 'Charm', 'Climbing ability', 'Combat', 'Courage', 'Damage', 'Defence', 'Detection', 'Devotion', 'Dualism', 'Encumbrance', 'Endurance', 'Evade', 'Explorer', 'Faith', 'Fatigue', 'First strike', 'Flee', 'Health', 'Huntsman', 'Killshot', 'Knowledge', 'Literacy', 'Logistics', 'Luck', 'Mountaineering', 'Navigator', 'Oration', 'Parry', 'Pickpocketing', 'Piercing', 'Piety', 'Precision', 'Recovery', 'Redemption', 'Regeneration', 'Renown', 'Reputation', 'Resist blunt', 'Resist flame', 'Resist frost', 'Resist holy', 'Resist piercing', 'Resist poison', 'Resist shadow', 'Resist slashing', 'Riposte', 'Sanctity', 'Sanity', 'Slashing', 'Speed', 'Spell limit', 'Stamina', 'Stealth', 'Storage', 'Survivalist', 'Trustworthiness', 'Understanding', 'Virtue', 'Vision', 'Weapon affinity', 'Woodsman']
ALL_ATTRIBUTE_NAMES = ['accuracy', 'adventuring', 'bartering', 'block', 'block_amount', 'blunt', 'caution_level', 'charm', 'climbing_ability', 'combat', 'courage', 'damage', 'defence', 'detection', 'devotion', 'dualism', 'encumbrance', 'endurance', 'evade', 'explorer', 'faith', 'fatigue', 'first_strike', 'flee', 'health', 'huntsman', 'killshot', 'knowledge', 'literacy', 'logistics', 'luck', 'mountaineering', 'navigator', 'oration', 'parry', 'pickpocketing', 'piercing', 'piety', 'precision', 'recovery', 'redemption', 'regeneration', 'renown', 'reputation', 'resist_blunt', 'resist_flame', 'resist_frost', 'resist_holy', 'resist_piercing', 'resist_poison', 'resist_shadow', 'resist_slashing', 'riposte', 'sanctity', 'sanity', 'slashing', 'speed', 'spell_limit', 'stamina', 'stealth', 'storage', 'survivalist', 'trustworthiness', 'understanding', 'virtue', 'vision', 'weapon_affinity', 'woodsman']
ALL_CLASS_NAMES = ['Accuracy', 'Adventuring', 'Bartering', 'Block', 'BlockAmount', 'Blunt', 'CautionLevel', 'Charm', 'ClimbingAbility', 'Combat', 'Courage', 'Damage', 'Defence', 'Detection', 'Devotion', 'Dualism', 'Encumbrance', 'Endurance', 'Evade', 'Explorer', 'Faith', 'Fatigue', 'FirstStrike', 'Flee', 'Health', 'Huntsman', 'Killshot', 'Knowledge', 'Literacy', 'Logistics', 'Luck', 'Mountaineering', 'Navigator', 'Oration', 'Parry', 'Pickpocketing', 'Piercing', 'Piety', 'Precision', 'Recovery', 'Redemption', 'Regeneration', 'Renown', 'Reputation', 'ResistBlunt', 'ResistFlame', 'ResistFrost', 'ResistHoly', 'ResistPiercing', 'ResistPoison', 'ResistShadow', 'ResistSlashing', 'Riposte', 'Sanctity', 'Sanity', 'Slashing', 'Speed', 'SpellLimit', 'Stamina', 'Stealth', 'Storage', 'Survivalist', 'Trustworthiness', 'Understanding', 'Virtue', 'Vision', 'WeaponAffinity', 'Woodsman']
