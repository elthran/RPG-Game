...
class Lifesteal(Proficiency):
    ...
    __mapper_args__ = {
        'polymorphic_identity': "Lifesteal"
    }
    ...
    def scale_by_level(self, level=None):
        """Update Lifesteal's attributes and tooltip variable.
        """
