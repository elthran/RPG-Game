...
ALL_NAMES = ['Apprentice', 'Arcanum', 'Backstab', 'Bash', 'Blackhearted', 'Charmer', 'Discipline', 'Fame bomb test', 'Haggler', 'Ignore test1', 'Ignore test2', 'Ignore test3', 'Ignore test4', 'Ignore test5', 'Ignore test6', 'Ignore test7', 'Martial arts', 'Meditation', 'Poet', 'Relentless', 'Scholar', 'Skinner', 'Strider', 'Student', 'Traveler', 'Trickster', 'Vigilance', 'Virtue bomb test']
ALL_ATTRIBUTE_NAMES = ['apprentice', 'arcanum', 'backstab', 'bash', 'blackhearted', 'charmer', 'discipline', 'fame_bomb_test', 'haggler', 'ignore_test1', 'ignore_test2', 'ignore_test3', 'ignore_test4', 'ignore_test5', 'ignore_test6', 'ignore_test7', 'martial_arts', 'meditation', 'poet', 'relentless', 'scholar', 'skinner', 'strider', 'student', 'traveler', 'trickster', 'vigilance', 'virtue_bomb_test']
ALL_CLASS_NAMES = ['Apprentice', 'Arcanum', 'Backstab', 'Bash', 'Blackhearted', 'Charmer', 'Discipline', 'FameBombTest', 'Haggler', 'IgnoreTest1', 'IgnoreTest2', 'IgnoreTest3', 'IgnoreTest4', 'IgnoreTest5', 'IgnoreTest6', 'IgnoreTest7', 'MartialArts', 'Meditation', 'Poet', 'Relentless', 'Scholar', 'Skinner', 'Strider', 'Student', 'Traveler', 'Trickster', 'Vigilance', 'VirtueBombTest']
