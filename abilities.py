...
ALL_ABILITIES = [
    ...
    ("Martial Arts", "AuraAbility", "3, 'You deal {{ level * 5 }}% more damage in combat.', tree='archetype', tree_type='ascetic'"),
...
class Abilities(IterItemsExtension, AbilitiesRelationshipMixin, Base):
    ...
    def __init__(self):
            ...
            self.martial_arts = AuraAbility('Martial Arts', 3, 'You deal {{ level * 5 }}% more damage in combat.', tree='archetype', tree_type='ascetic')
