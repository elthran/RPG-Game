...
ALL_ABILITIES = [('Apprentice', 'AuraAbility', 'Archetype', 'Ascetic', 3, '(BROKEN) You are capable of learning additional spells.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Arcanum', 'AuraAbility', 'Basic', 'None', 5, 'Gain maximum sanctity. Master this ability to unlock the Philosopher archetype.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Sanctity', 5), ('Backstab', 'AuraAbility', 'Archetype', 'Scoundrel', 3, 'You are more likely to attack first in combat.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'FirstStrike', 5), ('Bash', 'AuraAbility', 'Archetype', 'Brute', 3, '(BROKEN)You deal more damage with blunt weapons.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Blackhearted', 'AuraAbility', 'Archetype', 'Scoundrel', 3, '(BROKEN)Lose virtue faster.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Charmer', 'AuraAbility', 'Archetype', 'Opportunist', 3, '(BROKEN)You are more likely to succeed when choosing charm dialogues.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Discipline', 'AuraAbility', 'Basic', 'None', 5, '(BROKEN)Gain devotion faster. Master this ability to unlock the Ascetic archetype.', '{{ (level) * 5 }}%', '{{ (level + 1) * 5 }}%', True, 'Health', 0), ('Haggler', 'AuraAbility', 'Archetype', 'Opportunist', 3, 'Prices at shops are cheaper.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Bartering', 5), ('MartialArts', 'AuraAbility', 'Archetype', 'Ascetic', 3, 'You deal more damage in combat.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'DamageMaximum', 5), ('Meditation', 'AuraAbility', 'Archetype', 'Ascetic', 3, 'Regenerate sanctity per day.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Redemption', 5), ('Poet', 'AuraAbility', 'Basic', 'None', 5, '(BROKEN)Gain fame faster. Master this ability to unlock the Opportunist archetype.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Relentless', 'AuraAbility', 'Basic', 'None', 5, 'Gain maximum health. Master this ability to unlock the Brute archetype.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 5), ('Scholar', 'AuraAbility', 'Archetype', 'Philosopher', 3, 'Gain experience faster.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Understanding', 5), ('Skinner', 'AuraAbility', 'Archetype', 'Survivalist', 3, '(BROKEN)You have a chance of obtaining a usable fur after kiling a beast.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Strider', 'AuraAbility', 'Archetype', 'Survivalist', 3, '(BROKEN)Traveling on the map requires less endurance.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Student', 'AuraAbility', 'Archetype', 'Philosopher', 3, '(BROKEN)You are capable of learning additional spells.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Traveler', 'AuraAbility', 'Basic', 'None', 5, '(BROKEN)Reveal more of the map when exploring new places. Master this ability to unlock the Survivalist archetype.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Trickster', 'AuraAbility', 'Basic', 'None', 5, '(BROKEN)Become harder to detect when performing stealthy activities. Master this ability to unlock the Scoundrel archetype.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0), ('Vigilance', 'AuraAbility', 'Archetype', 'Survivalist', 3, '(BROKEN)You are less likely to be ambushed.', '{{ (level) * 5 }}', '{{ (level + 1) * 5 }}', True, 'Health', 0)]
...
class Apprentice(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Apprentice', tree='Archetype', tree_type='Ascetic', max_level=3, description='(BROKEN) You are capable of learning additional spells.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Health', {'base': 0})])
...
class Arcanum(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Arcanum', tree='Basic', tree_type='None', max_level=5, description='Gain maximum sanctity. Master this ability to unlock the Philosopher archetype.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Sanctity', {'base': 5})])
...
class Discipline(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Discipline', tree='Basic', tree_type='None', max_level=5, description='(BROKEN)Gain devotion faster. Master this ability to unlock the Ascetic archetype.', current='{{ (level) * 5 }}%', next='{{ (level + 1) * 5 }}%', learnable=True, proficiency_data=[('Health', {'base': 0})])
...
class MartialArts(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='MartialArts', tree='Archetype', tree_type='Ascetic', max_level=3, description='You deal more damage in combat.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('DamageMaximum', {'base': 5})])
...
class Poet(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Poet', tree='Basic', tree_type='None', max_level=5, description='(BROKEN)Gain fame faster. Master this ability to unlock the Opportunist archetype.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Health', {'base': 0})])
...
class Relentless(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Relentless', tree='Basic', tree_type='None', max_level=5, description='Gain maximum health. Master this ability to unlock the Brute archetype.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Health', {'base': 5})])
...
class Traveler(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Traveler', tree='Basic', tree_type='None', max_level=5, description='(BROKEN)Reveal more of the map when exploring new places. Master this ability to unlock the Survivalist archetype.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Health', {'base': 0})])
...
class Trickster(AuraAbility):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(name='Trickster', tree='Basic', tree_type='None', max_level=5, description='(BROKEN)Become harder to detect when performing stealthy activities. Master this ability to unlock the Scoundrel archetype.', current='{{ (level) * 5 }}', next='{{ (level + 1) * 5 }}', learnable=True, proficiency_data=[('Health', {'base': 0})])
