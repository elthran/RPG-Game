...
Revision ID: d370ec783520
Revises: 
Create Date: 2018-04-02 10:27:28.114761
...
def upgrade():
    ...
    op.add_column('hero', sa.Column('spellbook_page', sa.Integer(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('hero', 'spellbook_page')
    ...
    op.add_column('ability', sa.Column('cost', mysql.VARCHAR(collation='utf8mb4_unicode_ci', length=50), nullable=True))
