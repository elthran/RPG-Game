...
Revision ID: 2705b1c78056
Revises: 
Create Date: 2018-03-29 19:19:15.332956
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_base_dict'))
    )
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_forum'))
    )
